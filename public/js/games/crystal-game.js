$(document).ready(function(){
	...
	// NOTES: user is not needed for just the crystal game and interferes with it
	...
	function genGame(){
		...
		//NOTES: for just the crystal collector and not the ultimate game, how do I connect modal without the server, json, etc.?
	...
	// object that holds crystal descriptions
	var crystalNames = [
		"blue gem",
		"green gem",
		"red gem",
	...
	// object connects or holds the images
	var crystalImgs= [
	...
	// connects descriptions with images
	var crystalURLs=[
		"/images/gem1_blue.png",
		"/images/gem2_green.png",
		"/images/gem3_red.png",
	...
	function addCrystal(){
		...
		if (userNumber < randoNumber){
			...
			$(".modal-title").text("Crystal Collector");
			$(".modal-text").text("Oh no! You've gone over. You'll need to get the exact combination in order to win the game.");
			// $(".modal-text").append("<img src='/images/gem3_red.png'></img>");
			// userImage = $("<img>").attr("src", user.sprite);
			// $(".modal-text").append(userImage);
			$("#game-modal").modal();
